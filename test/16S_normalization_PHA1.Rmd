...
# DL: I would put this definition, and the below, in a chunk before this called constants.
#   Moreover, in programming there's a rule to have constants, i.e. variables that don't change, in capitals.
rlength <- 150
...
PHA1 %>%
  ...
  # DL: Assuming you want to divide the count by the length use mutate to create count_length_ratio:
  mutate(count_length_ratio = n/ARG_length)
