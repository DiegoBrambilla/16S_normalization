...
#Filter out selected variables (Archaea, Eukarya and Viruses families)
    filter(!family %in% c("Baculoviridae", "Eimeriidae", "Methanobacteriaceae", "Methanoregulaceae", "Methanosaetaceae", "Methanosarcinaceae" , "Methanospirillaceae", "Myoviridae" , "Nitrosopumilaceae", "Podoviridae", "Potyviridae", "Siphoviridae", "Viruses_noname")) %>% 
